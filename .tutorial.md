...
Depending on the platform setup, the asset may initialize automatically or may need to be manually executed. To manually execute the asset, run the command `./gcp-dataflow-iam.sh` on the terminal.
...
## Explore IAM Setup and Networking for Dataflow Jobs

This asset enables you to explore IAM setup and networking for Dataflow jobs.
...
This asset enables you to perform the following activities:
 ...
 - Enable APIs
 - Create GCS bucket
 - Launch Dataflow job with IAM roles
 - Launch Dataflow job with private IPs
